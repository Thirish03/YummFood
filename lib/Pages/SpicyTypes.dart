...
class SpicyTypes extends StatefulWidget {
  final Function(Map<String, dynamic>) addToCart;

  SpicyTypes({required this.addToCart, super.key});

  @override
  State<SpicyTypes> createState() => _SpicyTypesState();
}

class _SpicyTypesState extends State<SpicyTypes>
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => SpicyCart()));
            },
          ),
        ],
      ),
