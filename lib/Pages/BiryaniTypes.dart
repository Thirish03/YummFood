...
List<BiryaniItemModel> foodItems = [
  BiryaniItemModel(
...
class BiryaniTypes extends StatefulWidget {
  final Function(Map<String, dynamic>) addToCart;

  BiryaniTypes({required this.addToCart, super.key});

  @override
  State<BiryaniTypes> createState() => _BiryaniTypesState();
}

class _BiryaniTypesState extends State<BiryaniTypes>
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => BiryaniCart()));
            },
          ),
        ],
      ),
