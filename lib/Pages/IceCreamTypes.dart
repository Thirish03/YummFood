...
class IceCreamTypes extends StatefulWidget {
  final Function(Map<String, dynamic>) addToCart;

  IceCreamTypes({required this.addToCart, super.key});

  @override
  State<IceCreamTypes> createState() => _IceCreamTypesState();
}

class _IceCreamTypesState extends State<IceCreamTypes>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => IceCart()));
            },
          ),
        ],
      ),
              ...
              FoodItem(
                  ...
                  onAddToCart: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => IceCart()));
